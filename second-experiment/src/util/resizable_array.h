...
#define ARRAY_APPEND   PREFIX_NAME(ARRAY_PREFIX, append)
#define ARRAY_CAPACITY PREFIX_NAME(ARRAY_PREFIX, capacity)
#define ARRAY_COUNT    PREFIX_NAME(ARRAY_PREFIX, count)
#define ARRAY_ELEMENTS PREFIX_NAME(ARRAY_PREFIX, elements)
#define ARRAY_GET      PREFIX_NAME(ARRAY_PREFIX, get)
#define ARRAY_RESIZE   PREFIX_NAME(ARRAY_PREFIX, resize)
