...
#define N_OP_CALL_SVA    0x00
#define N_OP_GLOBAL_REF  0x01
#define N_OP_GLOBAL_SET  0x02
#define N_OP_JUMP        0x03
#define N_OP_JUMP_IF     0x04
#define N_OP_JUMP_UNLESS 0x05
